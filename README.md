...
Then right-click the Container COMP > **Save Component** and save as `td-snapshot.tox`. After saving, run `./scripts/tox-expand.sh` to refresh the `tox/` expansion so the structural changes are tracked in git.
